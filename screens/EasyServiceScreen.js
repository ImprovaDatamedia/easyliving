    ...
    return (
        <View style={{flex:1,  backgroundColor: 'white'}}>
            <View style={{alignItems: 'left',borderRadius:5, marginBottom:7, paddingLeft:10, paddingRight:10, paddingBottom: 10, backgroundColor: 'white'}}>
                <Text  style={{color:'gray', paddingTop: 25,textAlign:'left', fontSize:16, backgroundColor: 'white'}}>
            ...
            <ScrollView style={{paddingTop:7, paddingLeft:5, paddingRight:5, backgroundColor:'#f8f8f8'}}>   
